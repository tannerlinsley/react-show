...
## Why?
- You need to animate, reveal, or collapse your dynamically sized react components. Everyone does!
- You want it smoothly animated. Like butter on a glide-cam!
- You don't want to bloat up your app with custom physics-based animation frameworks or even jQuery (heaven forbid).
...
const CustomExample = () => (
  <ReactShow
    show={true || false} // Toggle true or false to show or hide the content!
    styleHide={{ // This style will be used when hidden
      height: '0px',
      width: '0',
      opacity: 0
    }}
    styleShow={{ // This style will be used when shown
      height: 'auto',
      width: '100%',
      opacity: 1
    }}
